...
export const Register: React.FC = () => {
    ...
    // We watch person_type to toggle fields
    ...
    const validateCNPJ = async () => {
        ...
        try {
            ...
            if (!valid) {
                // Optional: Set form error manually if desired
            }
        } catch (error) {
    ...
    const onSubmit = async (data: FormData) => {
        ...
        // Validate file size manually (could be done in Zod via refinement efficiently but this works)
        ...
        // Block PJ submission if CNPJ is explicitly Invalid
        ...
        try {
            ...
            const payload: any = {
                ...
                consent_given: true,
                // Ensure we clean inputs based on type
            ...
            if (err.response?.data) {
                // Try to be smart about error messages
        ...
        <Container maxWidth="md" sx={{ py: 6 }}>
            <Paper sx={{ p: { xs: 3, md: 5 }, borderRadius: 4, boxShadow: 3 }}>
                ...
                <Box component="form" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    {/* Form Fields - Disabled if no Type (though default is PF now based on my code above, 
                        the prompt asked for 'Disabled until selection', so I'll remove defaultValues 'PF' 
                        and verify strict requirement) 
                    */}
